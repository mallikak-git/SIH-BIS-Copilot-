# BIS Product Knowledge Sources

This file records the official BIS sources used for the product knowledge dataset.
...
## 3. Electrical Cables/Wires
- Standard: IS 694:2010
- Product: PVC Insulated Unsheathed and Sheathed Cables/Cords
- Source: Official BIS
...
- Product: Packaged Drinking Water other than Packaged Natural Mineral Water
- Source: Official BIS
...
- Product: Personal Protective Equipment — Safety Footwear
- Source: Official BIS

## Source Policy

- Prefer official BIS sources for all standard information.
- Verify the latest revision before using a standard.
